    ...
    <div>
      ...
      <div className="csr-section">
        ...
        <div className="csr-container">
          <p>
            Le numérique “peut être un formidable outil de création de nouvelles
            valeurs durables, plus respectueuses de l’environnement et plus
            éthiques envers la société s’il est encadré et réfléchi en termes
            d’impacts" <a href="https://charter.isit-europe.org/"> (INR)</a>. Si
            on parle souvent de Responsabilité Numérique des Entreprises (RNE),
            je suis convaincue que chacun, quelle que soit sa position, a un
            rôle à jouer dans la promotion d'une utilisation éthique et durable
            du numérique.
          </p>
          <p>
            C'est pourquoi j'ai décidé d’apporter ma (petite) pierre à l’édifice
            et choisi d'appliquer les principes du numérique responsable dans le
            cadre du développement de ce projet. J’ai bien conscience que je
            suis loin d'être une experte et suis par conséquent très preneuse de
            vos retours et recommandations si vous en avez. Les longs voyages
            commencent toujours par un premier pas, alors voici le mien sur le
            chemin du numérique responsable !
          </p>
          ...
          <div className="csr-actions">
            ...
            <ul>
              <li>
                <p>
                  Utilisation de polices optimisées pour le web (Google Fonts)
                  qui sont spécialement conçues pour réduire le temps de
              ...
              <li>
                <p>
                  {" "}
                  Lorsque des images sont utilisées, elles sont au format WebP,
                  plus léger et plus efficace en termes de chargement.{" "}
                </p>
              </li>
              <li>
                <p>
                  Utilisation d’icônes « semi-solid » pour réduire la
                  consommation d'encre, notamment lors de l'impression du CV.
                </p>
              </li>
              <li>
                <p>
                  ...
                  couleurs possèdent toutes un taux d’encrage inférieur à 100%.
                </p>
              </li>
              <li>
                <p>
                  Absence de requêtes ou de plugins externes (notamment pour le
                  style) pour optimiser la performance.
                </p>
              </li>
            </ul>
            ...
            <div className="csr-optimisations">
              <p className="csr-optimisations-title">
                Optimisations envisagées dans les futures versions du portfolio
              </p>
              <ul>
                <li>
                  {" "}
                ...
                <li>
                  <p>Optimisation du code pour améliorer les performances. </p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="csr-actions">
            ...
            <ul>
              <li>
                <p>
                  Utilisation de polices accessibles, claires et lisibles. Les
                  deux polices principales sont Luciole et Atkinson
                  Hyperlegible, deux typographies conçues spécialement pour
                  faciliter la lecture des personnes malvoyantes. Pour le print
                  une taille minimum de 12px pour le texte et de 16px pour les
                  titres ont été choisis.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  Optimisation de mon Readme GitHub pour qu’il corresponde aux
            ...
            <div className="csr-optimisations">
              ...
              <ul>
                ...
                <li>
                  <p>
                    Possibilité de gérer la taille du texte et de changer les
                    couleurs du site en fonction du type de vision.
                  </p>
                </li>
              </ul>
            </div>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.w3.org/WAI/standards-guidelines/wcag/fr">
                  "Règles pour l’accessibilité des contenus Web (WCAG) 2 – Vue
                  d’ensemble" (W3C)
                </a>
              </li>
              ...
              <li>
                <a href="https://www.concept-image.fr/blog/eco-couleurs/">
                  "Eco-couleurs : une charte graphique éco-responsable pour le
                  web et le print" (Concept Image)
                </a>
              </li>
              <li>
                <a href="https://www.concept-image.fr/blog/eco-couleurs/">
                  "Les bonnes pratiques pour éco-concevoir un site web" (UseWeb)
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://github.com/orgs/community/discussions/64778">
                  "Tips for Making your GitHub Profile Page Accessible" (GitHub
                  Community)
                </a>
              </li>
            </ul>
